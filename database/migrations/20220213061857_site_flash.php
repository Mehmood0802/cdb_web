...
class SiteFlash extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('site_flash', ['collation'=>'utf8mb4_general_ci'] );
        $table->addColumn('sort', 'integer', ['limit'=>4,'default'=>0 , 'comment'=>'排序' ]  )
              ...
              ->addColumn('url', 'string',[ 'default'=>'' , 'comment'=>'地址' ])
              ->addColumn('type', 'integer',[ 'default'=>0 , 'comment'=>'0-外链 1-内链 2-其他' ])
